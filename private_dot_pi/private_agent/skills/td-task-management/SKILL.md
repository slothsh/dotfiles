...
- `td create "title" --type feature --priority P1 --description "Description of task"` - Create
- `td edit "title" --type feature --priority P1 --description "Description of task"` - Edit
- `td list` - List all
